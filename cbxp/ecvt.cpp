...
nlohmann::json ECVT::get() {
  ...
  Logger::getInstance().hexDump(reinterpret_cast<const char *>(p_ecvt), sizeof(struct ecvt));
  ...
  ecvt_json["ecvt_boostinfo_v1"] = 
                                formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvt_boostinfo_v1))+
                                formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvt_boostinfo_v1+ 8)) +
                                formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvt_boostinfo_v1+ 16)) +
                                formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvt_boostinfo_v1+ 24));

  ecvt_json["ecvt_boostinfo_v2"] = 
                                formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvt_boostinfo_v2))+
                                formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvt_boostinfo_v2+ 8)) +
                                formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvt_boostinfo_v2+ 16)) +
                                formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvt_boostinfo_v2+ 24));

  ecvt_json["ecvt_cms_lockinst_addr"] = formatter_.getHex<uint32_t>(p_ecvt->ecvt_cms_lockinst_addr);
  ecvt_json["ecvt_customer_area_addr"] = formatter_.getHex<uint32_t>(p_ecvt->ecvt_customer_area_addr);
  ecvt_json["ecvt_enqdeq_cms_lockinst_addr"] = formatter_.getHex<uint32_t>(p_ecvt->ecvt_enqdeq_cms_lockinst_addr);
  ecvt_json["ecvt_getsrbidtoken"] = formatter_.getHex<uint32_t>(p_ecvt->ecvt_getsrbidtoken);
  ...
  ecvt_json["ecvt_latch_cms_lockinst_addr"] = formatter_.getHex<uint32_t>(p_ecvt->ecvt_latch_cms_lockinst_addr);
  ...
  ecvt_json["ecvtappflags"] = formatter_.getBitmap<uint32_t>(p_ecvt->ecvtappflags);
  ecvt_json["ecvtcachelinesize"] = formatter_.getBitmap<uint16_t>(reinterpret_cast<char *>(&p_ecvt->ecvtcachelinesize));
  ecvt_json["ecvtcachelinestartbdy"] = formatter_.getBitmap<uint8_t>(reinterpret_cast<char *>(&p_ecvt->ecvtcachelinestartbdy));
  ...
  ecvt_json["ecvtcsvn"] = formatter_.getBitmap<uint16_t>(reinterpret_cast<char *>(&p_ecvt->ecvtcsvn));
  ...
  //ecvt_json["ecvtdpqh"] = formatter_.getHex<uint32_t>(p_ecvt->ecvtdpqh); ---> Protection Exception
  ...
  ecvt_json["ecvtgmod"] = formatter_.getBitmap<uint8_t>(reinterpret_cast<char *>(&p_ecvt->ecvtgmod));
  ...
  ecvt_json["ecvtldto"] = formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvtldto)) + 
                          formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvtldto+8));
  ecvt_json["ecvtlogicaltophysicalmask"] = formatter_.getBitmap<uint16_t>(reinterpret_cast<char *>(&p_ecvt->ecvtlogicaltophysicalmask));
  ecvt_json["ecvtlpdelen"] = formatter_.getBitmap<uint8_t>(reinterpret_cast<char *>(&p_ecvt->ecvtlpdelen));
  ...
  ecvt_json["ecvtlso"] = formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvtlso)) + 
                         formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvtlso+8));
  ecvt_json["ecvtmaxcoreid"] = formatter_.getBitmap<uint16_t>(reinterpret_cast<char *>(&p_ecvt->ecvtmaxcoreid));
  ecvt_json["ecvtmaxmpnumbytesinmask"] = p_ecvt->ecvtmaxmpnumbytesinmask;
  ecvt_json["ecvtnumcpuidsincore"] = formatter_.getBitmap<uint16_t>(reinterpret_cast<char *>(&p_ecvt->ecvtnumcpuidsincore));
  ...
  ecvt_json["ecvtpdvl"] = formatter_.getBitmap<uint8_t>(reinterpret_cast<char *>(&p_ecvt->ecvtpdvl));
  ecvt_json["ecvtphysicaltologicalmask"] = formatter_.getBitmap<uint16_t>(reinterpret_cast<char *>(&p_ecvt->ecvtphysicaltologicalmask));
  ...
  ecvt_json["ecvtvmnm"] = formatter_.getBitmap<uint64_t>(reinterpret_cast<char *>(&p_ecvt->ecvtvmnm));
  ecvt_json["ecvtvser"] = formatter_.getBitmap<uint32_t>(reinterpret_cast<char *>(&p_ecvt->ecvtvser));
